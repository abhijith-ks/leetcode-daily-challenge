 ...
 */
public class _5_WordSearchII_LC_212 {
    ...
    public void test() {
        ...
        List<String> output = Arrays.asList(new String[]{"eat","oath"});
        Assert.assertEquals(output.toString(), findWords(board, words).toString());
    }
}
