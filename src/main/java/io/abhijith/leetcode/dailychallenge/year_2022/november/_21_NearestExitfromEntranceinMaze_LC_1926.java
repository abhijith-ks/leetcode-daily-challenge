...
/**
 * LC: https://leetcode.com/problems/nearest-exit-from-entrance-in-maze/
 */
public class _21_NearestExitfromEntranceinMaze_LC_1926 {
    ...
    public void test() {
        ...
        int output = 1;
        Assert.assertEquals(output, nearestExit(input, entrance));
